...
angular.module('starter', ['ionic', 'ngCordova', 'ionic.cloud', 'starter.controllers', 'starter.services', 'ngMap', 'auth0.auth0', 'auth0.lock', 'angular-jwt'])
...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, appConfig) {
  ...
  .state('tab.scanner', {
    ...
    views: {
      'mainContent': {
        templateUrl: 'templates/'+appConfig.ENABLE_THEME+'/tab-scanner.html',
